...
{
    internal class DWDParticlesUnlitShaderCMI : BaseShaderGUI
    {
        // Properties
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            MaterialProperty zTest = BaseShaderGUI.FindProperty("_ZTest", properties);
            materialEditor.ShaderProperty(zTest, new GUIContent("ZTest"));
